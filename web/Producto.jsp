                                ...
                                <c:forEach var="em" items="${productos}">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="Btnedit" href="Controlador?menu=Producto&accion=Editar&id=${em.getId()}">Editar
                                            ...
                                            <a class="button" type="button" href="Controlador?menu=Producto&accion=Delete&id=${em.getId()}"><span class="button__text">Delete</span>
