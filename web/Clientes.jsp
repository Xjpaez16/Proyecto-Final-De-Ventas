                                ...
                                <c:forEach var="em" items="${clientes}" varStatus="n">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="Btnedit" href="Controlador?menu=Cliente&accion=Editar&id=${em.getId()}">Editar
                                            ...
                                            <a class="button" type="button" href="Controlador?menu=Cliente&accion=Delete&id=${em.getId()}"><span class="button__text">Delete</span>
